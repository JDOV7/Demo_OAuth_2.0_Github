...
const Login = () => {
  ...
  return (
    <>
      <div className="justify-center items-center text-center pt-24 pb-10">
        <h1 className="text-4xl font-sans font-bold">Login</h1>
      </div>
      <div className=" flex justify-center items-center text-center">
        <Link
          to={url}
          className="bg-gray-100 hover:bg-gray-300  font-semibold  px-4 rounded-2xl flex items-center text-black"
        >
          <span className="p-2">
            <svg
              className="h-6 w-6 "
